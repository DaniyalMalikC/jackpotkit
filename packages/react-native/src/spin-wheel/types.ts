...
export interface SpinWheelAccessibilityLabels<TValue = unknown> {
  readonly wheel?: string;
  readonly spin?: string;
  readonly spinning?: string;
  readonly result?: (result: SpinWheelResult<TValue>) => string;
}
...
export interface SpinWheelProps<TValue = unknown, TRequest = void> extends UseSpinWheelOptions<
  TValue,
  TRequest
> {
  readonly accessibilityLabel?: string;
  readonly accessibilityLabels?: SpinWheelAccessibilityLabels<TValue>;
