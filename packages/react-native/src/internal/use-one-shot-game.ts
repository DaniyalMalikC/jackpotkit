...
interface UseOneShotControllerOptions<TResult, TSelection> extends OneShotCallbacks<TResult> {
...
export function useOneShotController<TResult, TSelection>({
  ...
  resolveProvider,
  resolveRandom,
}: UseOneShotControllerOptions<TResult, TSelection>): OneShotController<TResult, TSelection> {
